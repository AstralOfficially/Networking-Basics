...
| | |  |  |  | 5 |  |  |             ->we need 5 Network from this reference, 
| | |  |  |  | 3 | 2 | 1 |           ->5 falls under 8, so if we count the number of jumps
                                     ->we jump 3 steps to 8, thus we hacked 3 bits from HOST Bits
