...
- **Borrowed Bits:** 3 bits (8 subnets available)
- **Usable Hosts / Subnet:** 30 hosts
- **Block Size (Increment):** 32

---

### Subnet Allocation Table

| Subnet Name | Subnet / Network ID | Subnet Mask | Usable Host Range | Broadcast IP | Usable Hosts |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **Subnet 1** | `192.168.1.0/27` | `255.255.255.224` | `192.168.1.1` - `192.168.1.30` | `192.168.1.31` | 30 |
| **Subnet 2** | `192.168.1.32/27` | `255.255.255.224` | `192.168.1.33` - `192.168.1.62` | `192.168.1.63` | 30 |
| **Subnet 3** | `192.168.1.64/27` | `255.255.255.224` | `192.168.1.65` - `192.168.1.94` | `192.168.1.95` | 30 |
| **Subnet 4** | `192.168.1.96/27` | `255.255.255.224` | `192.168.1.97` - `192.168.1.126` | `192.168.1.127` | 30 |
| **Subnet 5** | `192.168.1.128/27` | `255.255.255.224` | `192.168.1.129` - `192.168.1.158` | `192.168.1.159` | 30 |
| *Spare 6* | `192.168.1.160/27` | `255.255.255.224` | `192.168.1.161` - `192.168.1.190` | `192.168.1.191` | 30 |
| *Spare 7* | `192.168.1.192/27` | `255.255.255.224` | `192.168.1.193` - `192.168.1.222` | `192.168.1.223` | 30 |
| *Spare 8* | `192.168.1.224/27` | `255.255.255.224` | `192.168.1.225` - `192.168.1.254` | `192.168.1.255` | 30 |
